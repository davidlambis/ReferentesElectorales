package interedes.referenteselectorales.Activities;
...
import interedes.referenteselectorales.Controllers.DepartamentoController;
import interedes.referenteselectorales.Controllers.MunicipioController;
import interedes.referenteselectorales.Controllers.SectorController;
import interedes.referenteselectorales.Controllers.UserController;
import interedes.referenteselectorales.Controllers.ZoneController;
import interedes.referenteselectorales.CustomClass.HintSpinnerAdapter;
import interedes.referenteselectorales.Handler.HttpHandler;
import interedes.referenteselectorales.Models.City;
import interedes.referenteselectorales.Models.Department;
import interedes.referenteselectorales.Models.Sector;
import interedes.referenteselectorales.Models.Sesion;
import interedes.referenteselectorales.Models.User;
import interedes.referenteselectorales.Models.Zone;
import interedes.referenteselectorales.R;

public class RegisterUserActivity extends AppCompatActivity {

    //region Variables
    @BindView(R.id.ToolbarRegisterUser)
    ...
    @BindView(R.id.swTieneVehiculo)
    SwitchCompat swTieneVehiculo;
    @BindView(R.id.edtPlaca)
    EditText edtPlaca;
